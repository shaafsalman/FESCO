...
void changeCNIC(char* oldCnic)
{
	...
	cout << "\t\t\t\t\t\t\t|               Enter New CNIC:            |\n";
	cout << "\t\t\t\t\t\t\t:------------------------------------------:\n";
	getStringConsole(newCnic);

	while (!verifyCNICFormat(newCnic))
	{
		cout << "\t\t\t\t\t\t\t:------------------------------------------:\n";
		cout << "\t\t\t\t\t\t\t|               Wrong  CNIC:               |\n";
		cout << "\t\t\t\t\t\t\t:------------------------------------------:\n";
	...
	while (!verifyCNIC(newCnic))
	{
		cout << "\t\t\t\t\t\t\t:------------------------------------------:\n";
		cout << "\t\t\t\t\t\t\t|         CNIC not found in NADRADB:       |\n";
		cout << "\t\t\t\t\t\t\t:------------------------------------------:\n";
	...
	while (verifyCNICInCustomer(newCnic))
	{

		cout << "\t\t\t\t\t\t\t:------------------------------------------:\n";
		cout << "\t\t\t\t\t\t\t|          CNIC Already Exsists            |\n";
		cout << "\t\t\t\t\t\t\t:------------------------------------------:\n";
		delete[]newCnic;
...
void changeCustomerInfo()
{
	...
	{
	cout << "Enter the Old CNIC(Without Dashes): ";
	getStringConsole(data);

	while (!verifyCNICFormat(data))
	{
		cout << "Incorrect CNIC." << endl;
		cout << "Enter Again CNIC again: ";
		delete[]data;
		getStringConsole(data);
	}
	...
	{
		cout << "Customer with this CNIC does not exist." << endl;
		system("pause");
	}
